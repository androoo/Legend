...
extension UIView: Themeable {
    ...
    /**
     ...
     - Important:
     It is recommended that this method be only overridden.
...
extension UIView: ThemeProvider {
    ...
    /**
     ...
     By default the `theme` of all the `superview` is returned. If a `superview` does not exits, then the value is taken from `ThemeManager.theme`
